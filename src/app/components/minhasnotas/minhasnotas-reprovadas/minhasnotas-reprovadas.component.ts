...
@Component({
  selector: 'app-minhasnotas-reprovadas',
  templateUrl: './minhasnotas-reprovadas.component.html',
  styleUrls: ['./minhasnotas-reprovadas.component.scss']
})
export class MinhasnotasReprovadasComponent implements AfterViewInit {
